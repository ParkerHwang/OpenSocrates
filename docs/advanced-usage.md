...
selector call. See the [Antigravity support boundary](antigravity-support.md).
...
model call. See the [Cursor support boundary](cursor-support.md).
...
[Grok Build support boundary](grok-support.md).
...
[OpenCode support and evidence boundary](opencode-support.md).
...
Download the published release and verify its checksum before using Claude's
...
[OpenCode support boundary](opencode-support.md).
...
[clean Apple-silicon Mac acceptance procedure](clean-machine-acceptance.md)
...
[opt-in check](real-claude-selector.md). The authenticated v1.1.2 receipt
...
[aggregate reliability matrix](claude-structured-output-reliability.md).
...
[Apple-silicon timing receipt](claude-hook-timing.md). The observed v1.1.2
