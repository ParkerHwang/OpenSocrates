...
for (const [label, subjectVersion] of [
  ["patch bump ahead of VERSION", "1.1.5"],
  ["patch bump behind VERSION", "1.1.3"],
  ["digit-extended version", "1.1.40"],
  ["truncated version", "1.1"],
  ["major bump", "2.0.0"],
  ["zero-padded version", "1.01.4"],
  ["version with prerelease", "1.1.4-rc.1"],
]) {
...
for (const [label, refName] of [
  ["tag ahead of VERSION", "v1.1.5"],
  ["tag behind VERSION", "v1.1.3"],
  ["digit-extended tag", "v1.1.40"],
  ["tag without the v prefix", "1.1.4"],
  ["tag with a prerelease suffix", "v1.1.4-rc1"],
  ["tag with a trailing dot", "v1.1.4."],
  ["major-only tag", "v1"],
]) {
