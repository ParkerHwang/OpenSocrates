...
HOST_NAMES = ("antigravity", "claude", "codex", "cursor", "grok", "prompt_only")
    ...
    **kwargs: Any,
    ...
    if callable(loader):
        try:
            ...
            bundle = None
    adapter_types = {"cursor": CursorAdapter, "grok": GrokAdapter}
    adapter_type = adapter_types.get(selected, PromptOnlyAdapter)
    return adapter_type(
