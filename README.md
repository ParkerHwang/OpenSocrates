...
Existing `--host codex` and `--host claude` lifecycle commands remain supported.
A host-specific update can intentionally create drift; a later
...
Replace `claude` with `codex` or `antigravity` for the matching package.
