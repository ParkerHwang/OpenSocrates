...
Claude, Codex, and OpenCode. It detects requests that benefit from deliberate reasoning,
...
Replace `claude` with `antigravity`, `codex`, `cursor`, or `opencode` for the matching package.
