...
These instructions govern repository development only. OpenSocrates 1.4.0 supports Codex only; this contributor file does not provide a Claude product integration.
