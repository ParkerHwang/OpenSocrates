...
func TestHTTPContract(t *testing.T) {
	...
	if code != 200 || v["schema_version"] != float64(2) {
		t.Fatal(code, v)
	}
	...
	code, v = call("POST", "/v1/jobs", "t", "key", `{"queue":"q","payload":{"b":2,"a":1},"retry_base_ms":0}`)
	...
	code, v = call("POST", "/v1/jobs", "t", "key", `{"payload":{"a":1,"b":2},"max_attempts":3,"queue":"q","retry_base_ms":0}`)
