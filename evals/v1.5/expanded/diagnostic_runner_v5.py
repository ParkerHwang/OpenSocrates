...
def cell(freeze: dict, scheduled: dict) -> dict:  # noqa: C901
    ...
    output = HERE / "diagnostic-results-v5" / scheduled["id"]
    ...
    with tempfile.TemporaryDirectory(prefix="os-v15-diag-v5-", dir="/private/tmp") as temporary:
        base = Path(temporary)
...
def main() -> None:
    freeze, commit = harness.verify_freeze(HERE / "diagnostic-freeze.v5.json")
