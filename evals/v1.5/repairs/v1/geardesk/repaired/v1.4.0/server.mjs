...
const routes={'GET /api/catalog':'catalog','POST /api/quote':'quote','POST /api/availability':'availability','POST /api/command':'command','POST /api/batch':'batch','GET /api/reservations':'reservations','GET /api/maintenance':'maintenance','GET /api/report':'report'};
