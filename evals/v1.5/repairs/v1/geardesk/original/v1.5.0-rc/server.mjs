...
const routes={GET:{'/api/catalog':'catalog','/api/reservations':'reservations','/api/maintenance':'maintenance','/api/report':'report'},POST:{'/api/quote':'quote','/api/availability':'availability','/api/command':'command','/api/batch':'batch'}};
