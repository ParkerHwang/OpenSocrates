...
SOURCE='2339d8a9cc4283c00ee6c4a690566623430214dd'
ZIP_HASH='sha256:b96602080355130a6e29455e70ec3a2bb5546a16d264b8d69802f4638e42e2eb'
...
def run(locale,family,arm):
    ...
    profile='candidate' if arm=='J' else 'upfront';work=TEMP/profile/'work'/('scope-verification-'+cid);work.mkdir()
    observed={}
