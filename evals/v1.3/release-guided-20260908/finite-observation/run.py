...
SOURCE='8109176a353842e7d6a2612a4eda8db41988241c'
ZIP_HASH='sha256:5611866fe82a05c34d0ee6de378db5d23da6688766710d4efd0e04ebc12bbae1'
...
def run(locale,family,arm):
    ...
    profile='candidate' if arm=='J' else 'upfront';work=TEMP/profile/'work'/('finite-observation-'+cid);work.mkdir()
    observed={}
