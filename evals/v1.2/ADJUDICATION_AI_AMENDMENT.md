...
Date: 2026-08-13
Applies to: the 51-pair #65 development adjudication only
...
Results produced under this amendment are **provisional development gold**. They may
be used to:
...
- a silent replacement for the frozen schema 1.0.0 #65 results.
...
4. Codex performs schema normalization and disagreement synthesis. Codex is not an
   output-blind adjudicator because it has access to the surrounding #65 analysis;
