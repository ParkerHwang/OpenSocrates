...
[v1.5 구현 명세](docs/v1.5.0/README.md)에 따라 상태를 저장하지 않는
별도 지원 명령과 프로젝트별 명시적 등록이 필요한 로컬 메모리 명령,
영어·한국어 코딩 및 협업 안내를 개발하고 있습니다. 위 설치 안내는
출시된 1.4.0 패키지에 관한 것이며, 이 후보 기능의 설치나 검증을
뜻하지 않습니다. 소스 또는 패키지 검사만으로 모델 품질, 비용,
실제 Codex 전달 개선을 주장하지 않습니다.
[개발 중인 메모리 프로토콜](docs/project-memory-development.md)을 참고하세요.
